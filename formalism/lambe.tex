...
sig eq : forall a. List a -> List a -> bool with Equatable a
    ...
    \[\trfrac[(const-access)]
    {\Gamma \vdash r : \underline{c} S \qquad {\cal S}_\uparrow[S] \circledast \Gamma \vdash n : t}
    {\Gamma \vdash r.n : t} \]

    \[\trfrac[(trait-access)]
    {\Gamma \vdash r \longrightarrow \Gamma' \qquad \Gamma' \circledast \Gamma \vdash n : t}
    {\Gamma \vdash r.n : t} \]

    \[\trfrac[(trait-access)]
    {\Gamma \vdash r \longrightarrow \Gamma_1 \qquad \exists \Gamma_2 \circledast M \in {\cal W}[\Gamma_1], \Gamma_2 \circledast \Gamma \vdash r.n : t}
    {\Gamma \vdash r.n : t} \]

    \[\trfrac[($\forall$-elim)]
    {\Gamma \vdash e : \forall (a:k).t_1 \qquad \Gamma \vdash t_2 : k }
    ...
    \[\trfrac[($\exists$-elim)]
    {\Gamma \vdash e_1 : \exists (a:k).t_1 \qquad \Gamma \oplus {\cal K}_\uparrow[\{ a : k \}] \oplus {\cal T}_\uparrow[\{ a : t_1 \}] \vdash e_2 : t_2 \qquad A \not\in \term{ftv}(t_2)}
