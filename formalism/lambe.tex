...
\begin{document}
    ...
    \begin{math}
        ...
        \langle \_, \_, \_, W\rangle[n]_\tau & = & \Gamma'.t & \exists \Gamma \in W, \Gamma[n]_\tau = \Gamma'.t \\
        ...
        \langle \_, \_, \_, W\rangle[n]_\sigma & = & \Gamma'.t & \exists \Gamma \in W, \Gamma[n]_\sigma = \Gamma'.t \\
...
sig eq : forall a. List a -> List a -> bool with Equatable a
    ...
    \[\trfrac[(red-var)]
    {\Gamma[n]_\tau = t' \qquad \Gamma \vdash t' \longrightarrow_1 t''}
    {\Gamma \vdash n \longrightarrow_i t''}\]

    \[\trfrac[(red-apply)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Lambda(x:k).t_1' \qquad \Gamma \vdash t_2 : k \qquad \Gamma \vdash t_1'[t_2/x] \longrightarrow_1 t_3}
    {\Gamma \vdash t_1 ~ t_2 \longrightarrow_i t_3}\]

    \[\trfrac[(red-access-var]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma' \qquad \Gamma' \vdash n \longrightarrow_0 t_2 \qquad \Gamma \vdash \Gamma'.t_2 \longrightarrow_1 t_3}
    {\Gamma \vdash t_1.n \longrightarrow_i t_3}\]

    \[\trfrac[(red-access-apply)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'\qquad \Gamma \vdash \Gamma'.t_2 ~ \Gamma'.t_3 \longrightarrow_0 t_4}
    {\Gamma \vdash t_1.(t_2 ~ t_3) \longrightarrow_i t_4}\]

    \[\trfrac[(red-access-$+$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(t_2 + t_3) \longrightarrow_i \Gamma'.t_2 + \Gamma'.t_3}\]

    \[\trfrac[(red-access-$\Lambda$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(\Lambda(x:k).t_2) \longrightarrow_i \Lambda(x:k).(\Gamma'.t_2)}\]

    \[\trfrac[(red-access-$\rightarrow$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(t_2 \rightarrow t_3) \longrightarrow_i \Gamma'.t_2 \rightarrow \Gamma'.t_3}\]

    \[\trfrac[(red-$\looparrowright$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(t_2 \looparrowright t_3) \longrightarrow_i \Gamma'.t_2 \looparrowright \Gamma'.t_3}\]

    \[\trfrac[(red-$\forall$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(\forall (\alpha:k).t) \longrightarrow_i \forall (\alpha:k).(\Gamma'.t)}\]

    \[\trfrac[(red-$\exists$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(\exists (\alpha:k).t) \longrightarrow_i \exists (\alpha:k).(\Gamma'.t)}\]

    \[\trfrac[(red-$\mu$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.(\mu (\alpha).t) \longrightarrow_i \mu (\alpha).(\Gamma'.t)}\]

    \[\trfrac[(red-$\Gamma$)]
    {\Gamma \vdash t_1 \longrightarrow_1 \Gamma'}
    {\Gamma \vdash t_1.\Gamma'' \longrightarrow_i \Gamma'' \oplus \Gamma'}\]

    \[\trfrac[(red-$\mu$)]
    {\Gamma \vdash t[\mu(\alpha).t/\alpha] \longrightarrow_1 t'}
    {\Gamma \vdash \mu(\alpha).t \longrightarrow_1 t'}\]

    \[\trfrac[(id)]
    {}
    {\Gamma \vdash t \longrightarrow_1 t}\]
    ...
    \[\trfrac[(reduce-left)]
    {\Gamma \vdash t_1 \longrightarrow_0 t_1' \qquad \Gamma \vdash t_1' \subseteq t_2 }
    {\Gamma \vdash t_1 \subseteq t_2}\]

    \[\trfrac[(reduce-right)]
    {\Gamma \vdash t_2 \longrightarrow_0 t_2' \qquad \Gamma \vdash t_1 \subseteq t_2' }
    {\Gamma \vdash t_1 \subseteq t_2}\]
